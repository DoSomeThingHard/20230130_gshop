...
export default {
    ...
    mounted(){
        this.$store.dispatch('shopOptions/getShopGoods', ()=>{
    ...
    methods:{
        _initScroll(){
            ...
            new BScroll('.menu-wrapper',{
                scrollY: true,  // 默认的就是
                click: true     // 不拦截原生的click时间 默认是false拦截的
            })
        ...
        _initTops(){
            ...
            tops.push(top)
            // 找到所有分类的li
            // 或者使用 this.$refs.foodsUl.children
            const lis = this.$refs.foodsUl.getElementsByClassName('food-list-hook')
            // Array.prototype.slice.call(arguments)能将具有length属性的对象转成数组, 我们可以理解为就是 arguments.toArray().slice()
